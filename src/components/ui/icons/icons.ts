export const Icons = {
  groups: {
    ...
    class: "mt-1 h-8 w-8 shrink-0 fill-sky-400 dark:fill-sky-300",
    width: 48,
    height: 48,
  ...
  tools: {
    ...
    class:
      "mt-2 h-6 w-6 shrink-0 fill-neutral-700 hs-tab-active:fill-sky-400 dark:fill-neutral-300 dark:hs-tab-active:fill-sky-300 md:h-7 md:w-7",
    width: 48,
    height: 48,
    viewBox: "0 -960 960 960",
  },
